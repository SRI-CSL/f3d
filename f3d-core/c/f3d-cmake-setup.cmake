...
# FREEDIUS_USE_X will force this and use X11 instead of Cocoa or Carbon.


# with nested cmake directories add_definitions will add multiple times.
remove_definitions(-DHAVE_SBCL64 -DHAVE_SBCL -DHAVE_CMUCL -DHAVE_ALLEGRO)
...
# Macro to check Lisp type - for Mac OS X we may want to always build universal binaries...
#
# These days, most of the world is 64-bit, so we make that the
# default.  At some point we need to de-complicate this mess.
#
macro(check_lisp)
  set(LISP $ENV{LISP})
  ...
  if(NOT LISP)
    if(APPLE)
      set(LISP "sbcl32") # FIXME for 64 bit
    elseif(UNIX)
  ...
  if(NOT LISP MATCHES "^(sbcl32|sbcl64|cmucl|allegro)$")
    message(FATAL_ERROR 
      "LISP must be one of sbcl32 sbcl64 cmucl allegro")
  endif(NOT LISP MATCHES "^(sbcl32|sbcl64|cmucl|allegro)$")
