...
#|
:POINTER is represented by :INT  

Not sure why I made this choice rather than using ACL's foreign-pointers.
Perhaps ACL didn't implement foreign-pointers when I first did this.

|#

;;;(pushnew :acl-foreign-pointers *features*)
