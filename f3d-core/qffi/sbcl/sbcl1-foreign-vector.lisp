...
How about a model that allocates a largish pool of vector memory and
then uses PURIFY to turn these pools into static space?
...
(defparameter *prohibit-type-t-foreign-vectors* nil)
...
;;;
;;; Apparently unused, so far - but would be nice to have.
;;;
